...
public class Types {
	...
	public static Map<DRTask, DRTask.Record> toMapOfDRTaskDRTaskRecord(
			Object object) {
		if (object == null) {
			return null;
		}
	...
	public static Map<GPUGroup, GPUGroup.Record> toMapOfGPUGroupGPUGroupRecord(
			Object object) {
		if (object == null) {
			return null;
		}
	...
	public static Map<PIFMetrics, PIFMetrics.Record> toMapOfPIFMetricsPIFMetricsRecord(
			Object object) {
		if (object == null) {
			return null;
		}
	...
	public static Map<VMGuestMetrics, VMGuestMetrics.Record> toMapOfVMGuestMetricsVMGuestMetricsRecord(
			Object object) {
		if (object == null) {
			return null;
		}
		...
		for (Map.Entry entry : entries) {
			...
			VMGuestMetrics.Record value = toVMGuestMetricsRecord(entry
					.getValue());
			result.put(key, value);
		}
		return result;
	...
	public static Map<Crashdump, Crashdump.Record> toMapOfCrashdumpCrashdumpRecord(
			Object object) {
		if (object == null) {
			return null;
		}
	...
	public static Map<HostCrashdump, HostCrashdump.Record> toMapOfHostCrashdumpHostCrashdumpRecord(
			Object object) {
		if (object == null) {
			return null;
		}
	...
	public static Map<HostPatch, HostPatch.Record> toMapOfHostPatchHostPatchRecord(
			Object object) {
		if (object == null) {
			return null;
		}
	...
	public static Map<Message, Message.Record> toMapOfMessageMessageRecord(
			Object object) {
		if (object == null) {
			return null;
		}
	...
	public static Map<PoolPatch, PoolPatch.Record> toMapOfPoolPatchPoolPatchRecord(
			Object object) {
		if (object == null) {
			return null;
		}
	...
	public static Map<Secret, Secret.Record> toMapOfSecretSecretRecord(
			Object object) {
		if (object == null) {
			return null;
		}
	...
	public static Map<Subject, Subject.Record> toMapOfSubjectSubjectRecord(
			Object object) {
		if (object == null) {
			return null;
		}
	...
	public static Map<Tunnel, Tunnel.Record> toMapOfTunnelTunnelRecord(
			Object object) {
		if (object == null) {
			return null;
		}
	...
	public static PIF.Record toPIFRecord(Object object) {
		...
		record.currentlyAttached = toBoolean(map.get("currently_attached"));
		record.ipConfigurationMode = toIpConfigurationMode(map
				.get("ip_configuration_mode"));
		...
		record.tunnelAccessPIFOf = toSetOfTunnel(map
				.get("tunnel_access_PIF_of"));
		record.tunnelTransportPIFOf = toSetOfTunnel(map
				.get("tunnel_transport_PIF_of"));
		return record;
	}
	...
	public static SR.Record toSRRecord(Object object) {
		...
		record.allowedOperations = toSetOfStorageOperations(map
				.get("allowed_operations"));
		record.currentOperations = toMapOfStringStorageOperations(map
	...
	public static VBD.Record toVBDRecord(Object object) {
		...
		record.uuid = toString(map.get("uuid"));
		record.allowedOperations = toSetOfVbdOperations(map
				.get("allowed_operations"));
		record.currentOperations = toMapOfStringVbdOperations(map
				.get("current_operations"));
		...
		record.qosAlgorithmParams = toMapOfStringString(map
				.get("qos_algorithm_params"));
		record.qosSupportedAlgorithms = toSetOfString(map
				.get("qos_supported_algorithms"));
	...
	public static VDI.Record toVDIRecord(Object object) {
		...
		record.nameDescription = toString(map.get("name_description"));
		// record.residentOn = toHost(map.get("resident_on"));
		record.allowedOperations = toSetOfVdiOperations(map
				.get("allowed_operations"));
		record.currentOperations = toMapOfStringVdiOperations(map
				.get("current_operations"));
		record.SR = toSR(map.get("SR"));
	...
	public static VIF.Record toVIFRecord(Object object) {
		...
		record.uuid = toString(map.get("uuid"));
		record.allowedOperations = toSetOfVifOperations(map
				.get("allowed_operations"));
		record.currentOperations = toMapOfStringVifOperations(map
				.get("current_operations"));
		record.device = toString(map.get("device"));
		record.network = toNetwork(map.get("network"));
		record.VM = toVM(map.get("VM"));
	...
	public static VM.Record toVMRecord(Object object) {
		...
		record.snapshotTime = toDate(map.get("snapshot_time"));
		record.transportableSnapshotId = toString(map
				.get("transportable_snapshot_id"));
		record.blobs = toMapOfStringBlob(map.get("blobs"));
		record.tags = toSetOfString(map.get("tags"));
		record.blockedOperations = toMapOfVmOperationsString(map
	...
	public static VMPP.Record toVMPPRecord(Object object) {
		...
		record.backupFrequency = toVmppBackupFrequency(map
		...
		record.archiveTargetType = toVmppArchiveTargetType(map
				.get("archive_target_type"));
		record.archiveTargetConfig = toMapOfStringString(map
				.get("archive_target_config"));
		record.archiveFrequency = toVmppArchiveFrequency(map
				.get("archive_frequency"));
		record.archiveSchedule = toMapOfStringString(map
				.get("archive_schedule"));
	...
	public static VMGuestMetrics.Record toVMGuestMetricsRecord(Object object) {
		...
		record.PVDriversVersion = toMapOfStringString(map
				.get("PV_drivers_version"));
	...
	public static Event.Record toEventRecord(Object object) {
		...
		default:
			throw new RuntimeException(
					"Internal error in auto-generated code whilst unmarshalling event snapshot");
		}
		record.snapshot = b;
		return record;
	}
	...
	public static Host.Record toHostRecord(Object object) {
		...
		record.nameDescription = toString(map.get("name_description"));
		record.memoryOverhead = toLong(map.get("memory_overhead"));
		record.allowedOperations = toSetOfHostAllowedOperations(map
				.get("allowed_operations"));
		record.currentOperations = toMapOfStringHostAllowedOperations(map
				.get("current_operations"));
		...
		record.APIVersionVendorImplementation = toMapOfStringString(map
				.get("API_version_vendor_implementation"));
		record.enabled = toBoolean(map.get("enabled"));
		...
		record.externalAuthServiceName = toString(map
				.get("external_auth_service_name"));
		record.externalAuthConfiguration = toMapOfStringString(map
				.get("external_auth_configuration"));
	...
	public static Pool.Record toPoolRecord(Object object) {
		...
		record.haConfiguration = toMapOfStringString(map
				.get("ha_configuration"));
		record.haStatefiles = toSetOfString(map.get("ha_statefiles"));
		record.haHostFailuresToTolerate = toLong(map
				.get("ha_host_failures_to_tolerate"));
	...
	public static PoolPatch.Record toPoolPatchRecord(Object object) {
		...
		record.afterApplyGuidance = toSetOfAfterApplyGuidance(map
				.get("after_apply_guidance"));
		record.otherConfig = toMapOfStringString(map.get("other_config"));
		return record;
	}
	...
	public static Bond toBond(Task task, Connection connection)
			throws XenAPIException, BadServerResponse, XmlRpcException,
			BadAsyncResult {
		return Types.toBond(parseResult(task.getResult(connection)));
	}

	public static DRTask toDRTask(Task task, Connection connection)
			throws XenAPIException, BadServerResponse, XmlRpcException,
			BadAsyncResult {
	...
	public static PBD toPBD(Task task, Connection connection)
			throws XenAPIException, BadServerResponse, XmlRpcException,
			BadAsyncResult {
		return Types.toPBD(parseResult(task.getResult(connection)));
	}

	public static PCI toPCI(Task task, Connection connection)
			throws XenAPIException, BadServerResponse, XmlRpcException,
			BadAsyncResult {
		return Types.toPCI(parseResult(task.getResult(connection)));
	}

	public static PGPU toPGPU(Task task, Connection connection)
			throws XenAPIException, BadServerResponse, XmlRpcException,
			BadAsyncResult {
		return Types.toPGPU(parseResult(task.getResult(connection)));
	}

	public static PIF toPIF(Task task, Connection connection)
			throws XenAPIException, BadServerResponse, XmlRpcException,
			BadAsyncResult {
	...
	public static SM toSM(Task task, Connection connection)
			throws XenAPIException, BadServerResponse, XmlRpcException,
			BadAsyncResult {
		return Types.toSM(parseResult(task.getResult(connection)));
	}

	public static SR toSR(Task task, Connection connection)
			throws XenAPIException, BadServerResponse, XmlRpcException,
			BadAsyncResult {
		return Types.toSR(parseResult(task.getResult(connection)));
	}

	public static VBD toVBD(Task task, Connection connection)
			throws XenAPIException, BadServerResponse, XmlRpcException,
			BadAsyncResult {
	...
	public static VDI toVDI(Task task, Connection connection)
			throws XenAPIException, BadServerResponse, XmlRpcException,
			BadAsyncResult {
		return Types.toVDI(parseResult(task.getResult(connection)));
	}

	public static VGPU toVGPU(Task task, Connection connection)
			throws XenAPIException, BadServerResponse, XmlRpcException,
			BadAsyncResult {
		return Types.toVGPU(parseResult(task.getResult(connection)));
	}

	public static VIF toVIF(Task task, Connection connection)
			throws XenAPIException, BadServerResponse, XmlRpcException,
			BadAsyncResult {
	...
	public static VLAN toVLAN(Task task, Connection connection)
			throws XenAPIException, BadServerResponse, XmlRpcException,
			BadAsyncResult {
		return Types.toVLAN(parseResult(task.getResult(connection)));
	}

	public static VM toVM(Task task, Connection connection)
			throws XenAPIException, BadServerResponse, XmlRpcException,
			BadAsyncResult {
		return Types.toVM(parseResult(task.getResult(connection)));
	}

	public static VMPP toVMPP(Task task, Connection connection)
			throws XenAPIException, BadServerResponse, XmlRpcException,
			BadAsyncResult {
	...
	public static VMGuestMetrics toVMGuestMetrics(Task task,
			Connection connection) throws XenAPIException, BadServerResponse,
			XmlRpcException, BadAsyncResult {
	...
	public static VTPM toVTPM(Task task, Connection connection)
			throws XenAPIException, BadServerResponse, XmlRpcException,
			BadAsyncResult {
		return Types.toVTPM(parseResult(task.getResult(connection)));
	}

	public static Blob toBlob(Task task, Connection connection)
			throws XenAPIException, BadServerResponse, XmlRpcException,
			BadAsyncResult {
		return Types.toBlob(parseResult(task.getResult(connection)));
	}

	public static Console toConsole(Task task, Connection connection)
			throws XenAPIException, BadServerResponse, XmlRpcException,
			BadAsyncResult {
	...
	public static Host toHost(Task task, Connection connection)
			throws XenAPIException, BadServerResponse, XmlRpcException,
			BadAsyncResult {
		return Types.toHost(parseResult(task.getResult(connection)));
	}

	public static HostCpu toHostCpu(Task task, Connection connection)
			throws XenAPIException, BadServerResponse, XmlRpcException,
			BadAsyncResult {
		return Types.toHostCpu(parseResult(task.getResult(connection)));
	}

	public static HostCrashdump toHostCrashdump(Task task, Connection connection)
			throws XenAPIException, BadServerResponse, XmlRpcException,
			BadAsyncResult {
	...
	public static Message toMessage(Task task, Connection connection)
			throws XenAPIException, BadServerResponse, XmlRpcException,
			BadAsyncResult {
		return Types.toMessage(parseResult(task.getResult(connection)));
	}

	public static Network toNetwork(Task task, Connection connection)
			throws XenAPIException, BadServerResponse, XmlRpcException,
			BadAsyncResult {
		return Types.toNetwork(parseResult(task.getResult(connection)));
	}

	public static Pool toPool(Task task, Connection connection)
			throws XenAPIException, BadServerResponse, XmlRpcException,
			BadAsyncResult {
	...
	public static Role toRole(Task task, Connection connection)
			throws XenAPIException, BadServerResponse, XmlRpcException,
			BadAsyncResult {
		return Types.toRole(parseResult(task.getResult(connection)));
	}

	public static Secret toSecret(Task task, Connection connection)
			throws XenAPIException, BadServerResponse, XmlRpcException,
			BadAsyncResult {
		return Types.toSecret(parseResult(task.getResult(connection)));
	}

	public static Session toSession(Task task, Connection connection)
			throws XenAPIException, BadServerResponse, XmlRpcException,
			BadAsyncResult {
		return Types.toSession(parseResult(task.getResult(connection)));
	}

	public static Subject toSubject(Task task, Connection connection)
			throws XenAPIException, BadServerResponse, XmlRpcException,
			BadAsyncResult {
		return Types.toSubject(parseResult(task.getResult(connection)));
	}

	public static Task toTask(Task task, Connection connection)
			throws XenAPIException, BadServerResponse, XmlRpcException,
			BadAsyncResult {
		return Types.toTask(parseResult(task.getResult(connection)));
	}

	public static Tunnel toTunnel(Task task, Connection connection)
			throws XenAPIException, BadServerResponse, XmlRpcException,
			BadAsyncResult {
		return Types.toTunnel(parseResult(task.getResult(connection)));
	}

	public static User toUser(Task task, Connection connection)
			throws XenAPIException, BadServerResponse, XmlRpcException,
			BadAsyncResult {
