...
public class VM extends XenAPIObject {
	...
	/*
	 * �������������˳�� boot_orderΪ"cd"��ʾ��Ӳ������ boot_orderΪ"dc"��ʾ�ӹ�������
	 * �ػ�״̬�¸ı������Ч
	 */
	...
	/*
	 * 设置虚拟机访问硬盘限速， type： read 和 write 单位： MB/s
	 */
	...
	/*
	 * 获取虚拟机IO限速 type：read和write 单位：MB/s
	 */
	...
	// map.put("memoryValue", new Long(1024)); 单位为MB
	// map.put("vlanId", new Long(2));
	// map.put("IOreadLimit", new Long(30)); //单位：MBps
	// map.put("IOwriteLimit", new Long(30)); //单位：MBps
	// map.put("newUuid", new String(""));
	// map.put("passwd", new String(""));
	// map.put("origin_passwd",  new String(""));
	// map.put("IP",  new String(""));
	// map.put("type", new String("linux")); //或者"windows"
