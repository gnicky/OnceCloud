...
public class OCHost {
	...
	public OCHost(String hostUuid, String hostPwd, String hostName,
			String hostDesc, String hostIP, Integer hostMem, Integer hostCpu,
			String kernelVersion, String xenVersion, Integer hostStatus,
			String rackUuid, Date createDate) {
		super();
