$(document).ready(function () {
    ...
    function getVnetBasicList() {
        $('#basic-list').html("");
        var vnUuid = $('#platformcontent').attr("vnUuid");
        $.ajax({
            type: 'get',
            url: '/VnetAction',
            data: "action=getonevnet&vnUuid=" + vnUuid,
            dataType: 'json',
            success: function (obj) {
                var showstr = '<a class="id">vn-' + vnUuid.substring(0, 8) + '</a>';
    ...
    function getVxnets() {
        ...
        $.ajax({
            type: 'get',
            url: '/VnetAction',
            data: "action=getVms&vnUuid=" + vnUuid,
            dataType: 'json',
