			...
			<form class="form form-horizontal" id="createinfo-form">
				<fieldset>
					<div class="item">
						...
						<div class="controls">
							<input type="text" id="volume_name" name="volume_name" autofocus="">
						</div>
					</div>
					<div class="item">
					...
					<div class="item">
						...
						<div class="controls">
							<span class="help">IO&nbsp;吞吐&nbsp;36&nbsp;MB/s，单块最小容量10GB、最大容量500GB。</span>
						</div>
					</div>
					<div class="item">
						...
						<div class="controls size">
							...
							<input id="size" type="text" class="mini" value="10" style="margin-left:10px">
