...
<div class="content detail" id="platformcontent" platformUserId="<%=user.getUserId()%>" vncServer="<%=vncServer%>" instanceUuid="<%=instanceUuid%>" platformBasePath="<%=basePath %>">
	...
	<div class="col-md-8">
		<div class="detail-item detail-right" style="padding:30px 50px">
			...
			<h4 class="chart-title">
				硬盘<div class="chart-label">间隔：<span class="chart-span">5 分钟<span></div>
			</h4>
			<div id="chart-area-3">
				<div id="vbdpic"></div>
			</div>
	...
	<input type="hidden" id="instanceid" value="<%=instanceid %>">
	 <div class="col-md-8">
	   ...
	   <div class="col-md-2 actions">
	      <div class="graph-actions"><a id="uistart" class="btn btn-forbidden" href="#" >
	       <span class="glyphicon glyphicon-play"></span>
	        ...
	        <a id="uiclose" class="btn" href="#"><span class="glyphicon glyphicon-stop"></span>
	        <span class="text">关机</span></a><a id="uirestart" class="btn" href="#">
	        <span class="glyphicon glyphicon-refresh"></span>
	        <span class="text">重启</span></a>
	        <!-- <a class="btn" href="#">
	     ...
	     <!--    <a class="btn" href="#">
	        ...
	        <a id="destroy" class="btn btn-danger" href="#"><span class="glyphicon glyphicon-trash"></span>
	       ...
	       <!--  <a class="btn btn-forbidden" href="#">
	        ...
	        <!-- 路由网络 开始 -->
	        <div class="graph-component component-instance-network" id="instancerouterDiv">
	             <div class="graph-component component-instance-router" id="componentInstanceRouterDiv">
	             <div class="graph-component component-instance-router-network">
	               <div class="graph-component component-router-cloud">
                   </div>
	                   <a id="routerbingpublic" class="btn" href="#" >
		                <span class="glyphicon glyphicon-globe"></span>
		                <span class="text">绑定公网IP</span>
	                  </a> 
                   
	                 <div class="graph-component component-router-eip" id="routerunbingpublic"  style="display:none">
	                    <a class="btn-delete" href="#" id="deleteroutereip"><span class="glyphicon glyphicon-remove"></span></a>
		                 <span class="glyphicon glyphicon-globe"></span>
		                 <a class="component-id" href="#" data-permalink=""></a>
	                 </div>
	                 <div class="graph-component component-router-vxnet0"></div>
                 </div>
                 <div class="graph-component component-router-sg" id="componentRouterSgDiv">
                  <a class="sg-name" href="#" data-permalink=""></a>
                  <a class="btn" href="#" id="componentRouterSgbtn"><span class="glyphicon glyphicon-pencil"></span>
                  <span class="text">修改防火墙</span></a></div>
                  <div class="graph-component component-router" id="componentRouterDiv">
                  <span class="private-ip"></span>
                  <a class="router-id" href="#" data-permalink=""></a>
                  </div>
                  </div>
                  <div class="graph-component component-managed-vxnet">
                     <a class="btn-show-router" href="#" id="btnshowrouter"></a>
	        ...
	        <!-- 路由网络 结束 -->
	         ...
	         <!--    公网ip开始 -->
              ...
              <a id="bingpublic" class="btn" href="#" >
	            ...
	            <div class="graph-component component-instance-eip" style="display:none" id="unbindpublic">
	               <a class="btn-delete" href="#" id="deleteeip"><span class="glyphicon glyphicon-remove"></span>
	                </a><span class="glyphicon glyphicon-globe"></span><a class="component-id publicipname" 
	                data-permalink="">117.121.10.150</a></div> 
	  ...
	  <div class="col-md-4">
			...
			<dl id="basic-list2" class="my-horizontal"></dl>
		</div>
	  </div>
	</div>
