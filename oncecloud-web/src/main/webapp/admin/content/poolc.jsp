    	...
    	<div class="once-toolbar">
            ...
            <div class="btn-group">
				...
				<ul class="dropdown-menu">
					<li style="display:none"><a class="btn-forbidden" id="load" url="<%=basePath %>admin/modal/addtorack.jsp" disabled><span class="glyphicon glyphicon-road"></span>添加到机架</a></li>
					<li style="display:none"><a class="btn-forbidden" id="unload" disabled><span class="glyphicon glyphicon-save"></span>从机架中移除</a></li>
					<li><a class="btn-forbidden" id="update" url="<%=basePath %>admin/create/createpool.jsp" disabled><span class="glyphicon glyphicon-pencil"></span>修改</a></li>
					<li><a class="btn-forbidden" id="consistency" disabled><span class="glyphicon glyphicon-check""></span>校验一致性</a></li> 
				...
				<table>
					<tr>
						...
						<td style="padding-left:10px">
							<div>
								<ul id="poolP" style="display:inline">
								</ul>
							</div>
						</td>
					</tr>
