    	...
    	<div class="once-toolbar">
            ...
            <div class="btn-group">
				...
				<ul class="dropdown-menu">
					<li><a class="btn-forbidden" id="load" url="<%=basePath %>admin/modal/addtohost.jsp" disabled><span class="glyphicon glyphicon-tasks"></span>添加到服务器</a></li>
		            <li><a class="btn-forbidden" id="update" url="<%=basePath %>admin/create/createstorage.jsp" disabled><span class="glyphicon glyphicon-pencil"></span>修改</a></li>
