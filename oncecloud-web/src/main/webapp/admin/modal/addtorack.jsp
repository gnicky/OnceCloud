...
%>
<script src="<%=basePath %>admin/js/modal/addtorack.js"></script>
<div class="modal-dialog" style="width:600px; margin-top:100px">
	<div class="modal-content">
		<div class="modal-header">
			<h4 class="modal-title">选择机架<a class="close" data-dismiss="modal" aria-hidden="true"><span class="glyphicon glyphicon-remove"></span></a></h4>
		</div>
		...
		<div class="modal-footer">
			<button id="bind2rack" class="btn btn-primary" type="button" data-dismiss="modal">提交</button>
