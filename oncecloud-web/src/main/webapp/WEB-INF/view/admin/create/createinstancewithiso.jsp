			...
			<div class="row" style="margin:0; background-color:#cfeaf8">
						...
						<div>
							<div class="wizard-inner">
								<div class="once-toolbar" style="margin:0 0 10px 0">
									<div class="provider">
										模板提供方: <a href="#" class="provider-filter selected" type="system">系统</a> <a href="#" class="provider-filter" type="user">自有</a>
									</div>
									<div class="toolbar-right">
										<table>
											<tr>
												<td>页数&nbsp;<a id="currentPtpl"></a>&nbsp;/&nbsp;<a id="totalPtpl"></a></td>
						...
						<div>
							<div class="wizard-inner">
								...
								<div class="cpu options">
									...
									<div class="types-options cpu-options " core="2">
										2核
									</div>
									<div class="types-options cpu-options " core="4">
										4核
									</div>
									<div class="types-options cpu-options " core="8">
										8核
									</div>
								</div>
								<h6>内存</h6>
								<div class="memory options">
									...
									<div class="types-options memory-options disabled" capacity="16">
										16G
									</div>
									<div class="types-options memory-options disabled" capacity="24">
										24G
									</div>
									<div class="types-options memory-options disabled" capacity="32">
										32G
									</div>
								</div>
							</div>
						...
						<div class="wizard-network">
							<div class="wizard-inner">
								...
								<div class="vxnet-item selected">
									...
									<label class="id">ID:&nbsp;&nbsp;vlan-0</label>
								</div>
								<h3>私有网络</h3>
							...
							<form id="basicinfo-form">
								<div class="wizard-inner">
									...
									<div class="item keypair">
										...
										<div class="controls">
											<input type="disable" id="vmDefaultUser" name="" value="root" disabled>
										</div>
									</div>
									<div class="item passwd" style="">
										...
										<div class="controls">
											<input type="password" id="login_passwd" value="" name="login_passwd">
											<label class="inline">
												<input type="checkbox" id="display-pwd" name="toggle_passwd">
												&nbsp;显示密码 </label>
											<p class="alert alert-info" id="pw-alert" style="margin:10px 0; width:240px; padding:10px">密码至少8位，包括大小写字母和数字。</p>
										</div>
									</div>
								</div>
								<div class="wizard-action">
									<button class="btn btn-default btn-back" type="button">上一步</button>
									<button id="createvmAction" class="btn btn-primary btn-create" type="button">创建</button>
								</div>
							</form>
						</div>
					</div>
				...
				<div class="col-md-5">
					<div class="illustrate">
						...
						<h4> 总价&nbsp; <span class="price">0.10</span> <span class="unit">元/小时</span> <span class="unit">（合<strong>72.00</strong>元/月）</span> </h4>
					</div>
				</div>
			</div>
		</div>
