...
<script src="${basePath}js/user/modal/modifypptpuser.js"></script>
<div class="modal-dialog" style="margin-top:100px">
	<div class="modal-content">
		...
		<div class="modal-body" style="padding:0px 10px">
			<form class="form form-horizontal" id="pptpuser-form" pptpid="${pptpid}">
				<fieldset>
					<div class="item">
						<div style="padding-top:10px">
							...
							<div class="controls">
								<input type="text" id="pptp_name" name="pptp_name"
									style="width: 200px !important;background:#eee" value="${pname}" disabled="disabled">
							</div>
						</div>
						<div style="padding-top:10px">
