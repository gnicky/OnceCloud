...
<script src="${basePath}js/user/modal/bindtorouter.js"></script>
			...
			<form class="form form-horizontal" id="create-form">
				<fieldset>
					<div class="item" style="margin-bottom:30px">
						<div class="control-label" style="width:150px">私有网络</div>
						<div class="controls" style="margin-left:170px">
							<div class="select-con">
								<select class="dropdown-select" id="vn_vnet" name="vn_vnet">				
  								</select>
  							</div>
						</div>
					</div>
