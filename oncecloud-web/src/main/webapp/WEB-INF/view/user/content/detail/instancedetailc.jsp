	...
	<div class="row" style="margin: 0; border-bottom: 1px solid #f3f3f3">
		<div class="col-md-4">
			<ol class="breadcrumb oc-crumb img-crumb" style="border-bottom: none">
				<li><a href="${basePath}instance"> <span
						class="glyphicon glyphicon-cloud cool-orange"> </span> <span
						class="ctext"> INSTANCE </span>
				</a></li>
				<li class="active"><a href="${basePath}instance/detail">
						${showId} </a></li>
			</ol>
		</div>
		<div class="col-md-8">
					...
					<div class="graph-component component-instance-network"
						...
						<div class="graph-component component-instance-router"
							...
							<div class="graph-component component-instance-router-network">
								...
								<a id="routerbingpublic" class="btn" href="#"> <span
									class="glyphicon glyphicon-globe"> </span> <span class="text">
										绑定公网IP </span>
								</a>
								<div class="graph-component component-router-eip"
									id="routerunbingpublic" style="display: none">
									<a class="btn-delete" href="#" id="deleteroutereip"> <span
										class="glyphicon glyphicon-remove"> </span>
									</a> <span class="glyphicon glyphicon-globe"> </span> <a
										class="component-id" href="#" data-permalink=""> </a>
								</div>
								<div class="graph-component component-router-vxnet0"></div>
							</div>
							<div class="graph-component component-router-sg"
								id="componentRouterSgDiv">
								<a class="sg-name" href="#" data-permalink=""> </a> <a
									class="btn" href="#" id="componentRouterSgbtn"> <span
									class="glyphicon glyphicon-pencil"> </span> <span class="text">
										修改防火墙 </span>
								</a>
							</div>
							<div class="graph-component component-router"
								id="componentRouterDiv">
								<span class="private-ip"> </span> <a class="router-id" href="#"
									data-permalink=""> </a>
							</div>
						</div>
						<div class="graph-component component-managed-vxnet">
							<a class="btn-show-router" href="#" id="btnshowrouter"> </a> <a
								id="vxnetName" class="vxnet-name" href="#" data-permalink="">
								11 </a> <span class="private-ip"> </span>
						</div>
					</div>
