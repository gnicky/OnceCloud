  ...
  <div class="row" style="margin:0; border-bottom: 1px solid #f3f3f3">
      ...
      <ol class="breadcrumb oc-crumb" style="border-bottom:none">
        <li>
          ...
          <span class="glyphicon glyphicon-cloud cool-orange">
          </span>
          <span class="ctext">
          INSTANCE
          </span>
        ...
        <li class="active">
          <a href="${basePath}instance/detail">
          ${showId}
          </a>
        </li>
      </ol>
  ...
  <div id='textview'>
    ...
    <div class="col-md-8">
      <div class="detail-item detail-right" style="padding:30px 50px">
        ...
        <h4 class="chart-title"> CPU
          <div class="chart-label">间隔：
      ...
      <div class="graph-wrapper">
        ...
        <div class="col-md-2 actions">
          <div class="graph-actions">
            <a id="uistart" class="btn btn-forbidden" href="#" >
        ...
        <div class="col-md-10 components" id="componentsId">
            ...
            <div class="graph-component component-instance-router" id="componentInstanceRouterDiv">
              <div class="graph-component component-instance-router-network">
                ...
                <div class="graph-component component-router-eip" id="routerunbingpublic"  style="display:none">
                  <a class="btn-delete" href="#" id="deleteroutereip">
                  <span class="glyphicon glyphicon-remove">
                  </span>
                  </a>
                  <span class="glyphicon glyphicon-globe">
                  </span>
                  <a class="component-id" href="#" data-permalink="">
                  </a>
                </div>
              ...
              <div class="graph-component component-router-sg" id="componentRouterSgDiv">
                <a class="sg-name" href="#" data-permalink="">
                </a>
                <a class="btn" href="#" id="componentRouterSgbtn">
                <span class="glyphicon glyphicon-pencil">
                </span>
                <span class="text">
                修改防火墙
              ...
              <div class="graph-component component-router" id="componentRouterDiv">
                ...
                <a class="router-id" href="#" data-permalink="">
                </a>
              </div>
            </div>
            <div class="graph-component component-managed-vxnet">
              <a class="btn-show-router" href="#" id="btnshowrouter">
              </a>
              <a id="vxnetName" class="vxnet-name" href="#" data-permalink="">
              11
              </a>
              <span class="private-ip">
              </span>
          ...
          <div class="graph-component component-instance-network" id="instancenetworkDiv" style="display:none">
            ...
            <div class="graph-component component-instance-eip" style="display:none" id="unbindpublic">
              <a class="btn-delete" href="#" id="deleteeip">
              <span class="glyphicon glyphicon-remove">
              </span>
              </a>
              <span class="glyphicon glyphicon-globe">
              </span>
              <a class="component-id publicipname" 
	                data-permalink="">
              117.121.10.150
              </a>
            </div>
            <div class="graph-component component-vxnet0">
              <span class="vxnet-name">
              基础网络
              </span>
            </div>
          </div>
          ...
          <div class="graph-component component-instance-sg" id="instancesgDiv" style="display:none">
            <a class="sg-name"  data-permalink="" id="firewallId">
            缺省防火墙
            </a>
            <a class="btn" href="#" id="bingfirewall">
            <span class="glyphicon glyphicon-pencil">
            </span>
            <span class="text">
            加载防火墙规则
