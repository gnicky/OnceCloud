...
//
//	public abstract void update(String hostId, String hostName,
//			String hostDesc, String rackUuid, int userid);
//
//	public abstract boolean addHostToPool(String hostUuid, String poolUuid);
//
//	public abstract OCHost getPoolMaster(String poolUuid);
//
//	public abstract boolean ejectHostFromPool(String hostUuid);
//
//	public abstract boolean createPool(String hostUuid, String poolUuid);
//
//	public abstract OCHost addHost(String hostName, String hostPwd,
//			String hostDesc, String hostIp, String rackUuid);
//
